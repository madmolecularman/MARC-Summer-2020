...
* Housing issue is going to be a bit stressful
* Starting to figure out what the research your doing is
* Getting to go back onto campus
* 
...
Activity:
1) Develop an outline for your CV
...
Developing an outline
    * Some of the sections here are difficult to incorporate
    * There isn't a lot information to put sometimes
    * How do you add certain experiences like MARC to your CV
    
Refining your CV
    * What sections to add 
    * Some sections we don't have a lot of experience in
    * Spending the time to think through what you have done and the relevant skills for each project.
...
We had a good beginning to the session even though the University sent out a concerning emal about housing right before. I covered all of the questions and the new trainees are moving through getting paid. I also covered a lot of their question about abstracts. The intital warm up for the CV went well as this led to some discussion about point we would cover in the "discussion section". The Activity gave them time to work through the template and recognize how they might emulate sections.

**2. What did trainees learn? How do you know?**

They learned the difference between a resume, academic resume, and cv. They also learned that there are distinct sections in a CV and that those sections are modular. These are the main points of coversation we had in this session.

**3. What would you change about your session today?**

I would change how I approached new trainees submitting abstracts for ABRCMS. I think it would be great for new trainees to try and get an abstract in as this year for everyone is topsey turvey. I need to give them concrete actions that they can achieve for these projects.

**4. What specific content areas and study strategies did you recommend that trainees pursue before next week's sessions?**

There has been a lot going on this week. I really need to take the time to check in with them and make sure we are not pushing too hard.

**5. What are you considering as good use of next week's session?**

Next week we will be focusing on graduate school. I am going to use some of this time as a kind of panel for them to ask me their burning questions. I do have quite a bit of this session planned. 
