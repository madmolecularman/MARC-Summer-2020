...
|--------------------------|--------------------------------|
| Date created:6/15/2020   | Date implemented:6/18/2020     |
| Week in course:2         | Resources: Asher, UROC         |
...
Year One:
1) Create a graduate school timeline
2) Build a list of possible schools
3) Identify scholarships and fellowships
4) Clarify their intent to go to graduate school

Year Two:
1) Create a graduate school timeline
2) Refine their list of schools
3) Decide which scholarships and fellowships they are applying to
...
Year One: Create a list of possible schools
...
I recommend that you start to organize your schools with an excel spreadsheet. One is provided on the github page. Review this and allow it to guide your application process. Keep filling in as much information as possible. Add sections if you feel like. 
